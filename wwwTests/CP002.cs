...
namespace SeleniumTests
{
    ...
    public class CP002
    {
        ...
        [TestMethod]
        public void TheCP002TestChrome()
        {
            ...
            driver.FindElement(By.Id("txtNombreUs")).SendKeys("ade@gmail.com");
            driver.FindElement(By.Id("txtPass")).Clear();
            driver.FindElement(By.Id("txtPass")).SendKeys("asdfdasdfh");
