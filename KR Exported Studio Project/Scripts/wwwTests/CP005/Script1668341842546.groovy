...
selenium.type("id=txtPass", "admin")
selenium.click("id=btnEntrar")
selenium.open("https://localhost:44382/Pass.aspx")
selenium.click("id=txtPass")
selenium.type("id=txtPass", "Abcde1234")
selenium.click("xpath=//form[@id='form1']/div[3]/table/tbody/tr/td[2]/strong/span")
selenium.click("xpath=//form[@id='form1']/div[3]/table/tbody/tr/td[2]/strong/span")
selenium.doubleClick("xpath=//form[@id='form1']/div[3]/table/tbody/tr/td[2]/strong/span")
selenium.click("xpath=//form[@id='form1']/div[3]/table/tbody/tr/td[2]/strong/span")
softAssertion.assertEquals("CONTRASEÑA CADUCADA", selenium.getText("xpath=//form[@id='form1']/div[3]/table/tbody/tr/td[2]/strong/span"))
