...
selenium.type("id=txtNombreUs", ("usuariocaducado3@gmail.com").toString())
selenium.type("id=txtPass", "Admin1234")
...
selenium.click("id=lblError")
softAssertion.assertEquals("La contraseña ya ha sido utilizada", selenium.getText("id=lblError"))
